<%-- 
    Document   : admin
    Created on : 8/10/2020, 01:59:54 PM
    Author     : DiegoCanteo
--%>
...
<html>
    <head>
        ...
        <title>Sitio Web Admins</title>
    </head>
    <body>
        <div class="position-relative" style="max-height: 100vh; max-width: 100vw">
            <img src="img/2.jpg" class="img-index" alt="Responsive image" style="width: 100%; height: 100vh;">
            <div class="col-9 text-center text-light" style="position: absolute; bottom: 100px; color: white;">
                <div class="container col text-container">
                    <h1 class="text-center text-uppercase">Bienvenido al Apartado de Administradores</h1>
