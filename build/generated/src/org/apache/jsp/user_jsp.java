...
if(ses.getAttribute("Usuario")!=null && ses !=null && ses.getAttribute("nivel")!=null){
    ...
    response.sendRedirect("index.jsp");
      ...
      out.write("        <title>Sitio Web Users</title>\n");
      out.write("    </head>\n");
      out.write("    <body>\n");
      out.write("        <div class=\"position-relative\" style=\"max-height: 100vh; max-width: 100vw\">\n");
      out.write("            <img src=\"img/2.jpg\" class=\"img-index\" alt=\"Responsive image\" style=\"width: 100%; height: 100vh;\">\n");
      ...
      out.write("                    <h1 class=\"text-center text-uppercase\">Bienvenidos al Apartado de Usuario</h1>\n");
